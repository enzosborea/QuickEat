...
class __TwigTemplate_3be5c62ceb41a93ddfc9c762b35379233435bc889ead8528c90a24cb275a43d0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        echo "\">
    <button class=\"btn btn-danger mt-2 mb-2\">Supprimer</button>
</form>
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Supprimer ?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger mt-2 mb-2\">Supprimer</button>
</form>
", "user/_delete_form.html.twig", "/Users/sbo/Documents/Projet web/Quickeat/templates/user/_delete_form.html.twig");
    }
}
