...
class __TwigTemplate_512c4cff08899f3eacb5bff4034f8e8a8e7010e71952bc389a6979fd24755558 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 7, $this->source); })()), "user", [], "any", false, false, false, 7)) {
            // line 8
            echo "            <div class=\"d-flex justify-content-center shadow p-3 my-5 bg-warning rounded\">
        ...
        // line 17
        echo "            ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["emailForm"]) || array_key_exists("emailForm", $context) ? $context["emailForm"] : (function () { throw new RuntimeError('Variable "emailForm" does not exist.', 17, $this->source); })()), 'form');
        echo "
    </div>
";
    ...
    {
        return array (  108 => 17,  102 => 13,  99 => 12,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mot de passe | QuickEat{% endblock %}
...
{% endblock %}
", "security/forgotten_password.html.twig", "/Users/sbo/Documents/Projet web/Quickeat/templates/security/forgotten_password.html.twig");
    }
}
