...
class Restaurant extends \App\Entity\Restaurant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'categories', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'plats', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'Localisation', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'imageFilename', '' . "\0" . 'App\\Entity\\Restaurant' . "\0" . 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCategories(string $categories): \App\Entity\Restaurant
    {
     ...
     * {@inheritDoc}
     */
    public function setLocalisation(?\App\Entity\Localisation $Localisation): \App\Entity\Restaurant
    {
